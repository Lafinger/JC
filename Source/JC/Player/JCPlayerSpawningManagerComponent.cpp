...
//
// #include "JCPlayerSpawningManagerComponent.h"
...
//
// UJCPlayerSpawningManagerComponent::UJCPlayerSpawningManagerComponent(const FObjectInitializer& ObjectInitializer)
...
// }
//
// void UJCPlayerSpawningManagerComponent::InitializeComponent()
// {
...
// }
//
// void UJCPlayerSpawningManagerComponent::OnLevelAdded(ULevel* InLevel, UWorld* InWorld)
// {
// 	if (InWorld == GetWorld())
// 	{
...
// }
//
// void UJCPlayerSpawningManagerComponent::HandleOnActorSpawned(AActor* SpawnedActor)
// {
...
// //======================================================================
//
// AActor* UJCPlayerSpawningManagerComponent::ChoosePlayerStart(AController* Player)
// {
// 	if (Player)
// 	{
// #if WITH_EDITOR
...
//
// #if WITH_EDITOR
// APlayerStart* UJCPlayerSpawningManagerComponent::FindPlayFromHereStart(AController* Player)
// {
...
// #endif
//
// bool UJCPlayerSpawningManagerComponent::ControllerCanRestart(AController* Player)
// {
...
// }
//
// void UJCPlayerSpawningManagerComponent::FinishRestartPlayer(AController* NewPlayer, const FRotator& StartRotation)
// {
...
// //================================================================
//
// void UJCPlayerSpawningManagerComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
// {
// 	Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
// }
//
// APlayerStart* UJCPlayerSpawningManagerComponent::GetFirstRandomUnoccupiedPlayerStart(AController* Controller, const TArray<ALyraPlayerStart*>& StartPoints) const
// {
// 	if (Controller)
// 	{
